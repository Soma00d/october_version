$(document).ready(function(){
    ...
    var enableFreqContainer = $("#content_toolbox .diag_inge .enable_container .enable_volt_val");
...
//                                break;
            ...
            case "TOOLBOX": 
                ...
                if(message.type =="from_pic"){
                    //{"SLF":"0000","ENF":0000","TEN":"0000","RTL":"0000","TSS":"0000"}
                    var safetyFrequency = message.content.SLF;
                    var safetyVoltage = message.content.TEN;
                    var enableFrequency = message.content.ENF;
                    var enableVoltage = message.content.TEN;
